...
{
	if(file_exists("../Robot/Storage/surveys.txt"))
	{
		file_put_contents("../Robot/Storage/surveys.txt",$_POST['data']);
		$msg = "تنظیمات ذخیر شد";
	}
	else
	{
...
if(file_exists("../Robot/Storage/surveys.txt"))
{
	$data = file_get_contents("../Robot/Storage/surveys.txt");
}
else
{
...
<form action="" method="POST" enctype="multipart/form-data" accept-charset="utf-8" target="_self" class="form-horizontal form-plugin">
    ...
    <div class="row">
        <div class=" col-md-6 col-md-offset-3 ">
            ...
            <legend class="plugin-legend">نظرات کاربران</legend>
			<h4 class="message"><?php echo $msg; ?></h4>
        </div>
        <div class=" col-md-6 col-md-offset-3 ">

            <div class="form-group">
			<label for="x" class="form-group plugin-label">متن نظرات</label>
			<textarea id="x" class="form-control plugin-input" rows="5" name="data" placeholder="survey"><?php echo $data; ?></textarea>
            </div>
        </div>
        <div class=" col-md-6 col-md-offset-3 ">
